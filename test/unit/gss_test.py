...
class GoldenTestCase(unittest.TestCase):
    ...
    def test_not_none_on_three_elements_list(self) -> None:
        """Test for not returning None if list has at least three elements"""
        self.assertIsNotNone(self.gss.run([123.3, 456.6, 789.9]))

    def test_minimum_implicit_on_positive_ints(self) -> None:
        """Test for minimum on positive integers, with no optional extremum
        parameter"""
        self.assertEqual(self.gss.run([78, 23, 22, 21, 10, 4, 0, 1, 3, 11, 12,
                                       145]), 0)

    def test_minimum_explicit_on_positive_ints(self) -> None:
        """Test for minimum on positive integers, with optional extremum
        parameter specified"""
    ...
    def test_minimum_implicit_on_negative_ints(self) -> None:
        """Test for minimum on negative integers, with no optional extremum
        parameter"""
        self.assertEqual(self.gss.run([-1, -2, -3, -10, -9, -3, -1]), -10)

    def test_minimum_explicit_on_negative_ints(self) -> None:
        """Test for minimum on negative integers, with optional extremum
        parameter specified"""
    ...
    def test_minimum_implicit_on_ints(self) -> None:
        """Test for minimum on integers, with no optional extremum
        parameter"""
        self.assertEqual(self.gss.run([30, 1, 0, -1, -2, -3, -10, -9, -3, -1,
                                      1, 1000]), -10)

    def test_minimum_explicit_on_ints(self) -> None:
        """Test for minimum on integers, with optional extremum parameter
        specified"""
    ...
    def test_minimum_implicit_on_floats(self) -> None:
        """Test for minimum on floats, with no optional extremum parameter"""
        self.assertEqual(self.gss.run([12.3, 12.2, 12.19999, 3, 2.9999, 3.0,
                                      3.1, 3.2, 3.3, 3.4, 5, 66, 777, 888]),
                         2.9999)

    def test_minimum_explicit_on_floats(self) -> None:
        """Test for minimum on floats, with optional extremum parameter
        specified"""
        self.assertEqual(self.gss.run([12.3, 12.2, 12.19999, 3, 2.9999, -3.0,
                                      -2.99999, 0, 2.2, 1.3, 3.4, 5], True),
                         -3.0)
    ...
    def test_minimum_implicit_on_chars(self) -> None:
        """Test for minimum on chars, with no optional extremum parameter"""
        self.assertEqual(self.gss.run(['h', 'f', 'e', 'c', 'b', 'i', 'j', 'k',
                                      'v', 'w', 'z']), 'b')

    def test_minimum_explicit_on_chars(self) -> None:
        """Test for minimum on chars, with optional extremum parameter
        specified"""
    ...
    def test_minimum_implicit_on_strings(self) -> None:
        """Test for minimum on strings, with no optional extremum parameter"""
        self.assertEqual(self.gss.run(['strawberry', 'kiwi', 'cherry',
                                      'blueberry', 'banana', 'apple',
                         'avocado', 'mango', 'orange', 'pear']), 'apple')

    def test_minimum_explicit_on_strings(self) -> None:
        """Test for minimum on strings, with optional extremum parameter
        specified"""
